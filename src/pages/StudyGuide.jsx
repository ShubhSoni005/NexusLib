      ...
      <div className="guide-layout">
        ...
        <aside className="guide-sidebar animate-fade-up">
          ...
          <div className="suggestions">
            {SUGGESTIONS.map((s, i) => (
              <button key={i} className="suggestion-chip" onClick={() => { setInput(s); textRef.current?.focus(); }}>
                {s}
              </button>
            ))}
          </div>
        ...
        <div className="chat-container animate-fade-up delay-100">
          ...
          <div className="chat-input-area">
            ...
            <div className="chat-input-row">
              <div className="chat-input-box">
                <textarea
                  ...
                  placeholder="Ask about any GTU subject, upload notes, or paste a URL…"
                  value={input}
            ...
            <input
              ref={fileRef} type="file" accept=".pdf,.txt,.doc,.docx"
              style={{ display: 'none' }}
